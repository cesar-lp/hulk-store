...
insert into payment_order (id, created_at, total) values (1, '2020-02-28T09:37:15.939362', 450.00);
insert into payment_order (id, created_at, total) values (2, '2020-02-28T09:50:15.939362', 500.00);
insert into payment_order (id, created_at, total) values (3, '2020-02-28T14:50:15.939362', 100.00);

insert into product_order (id, product_id, product_name, product_price, quantity, total, payment_id)
