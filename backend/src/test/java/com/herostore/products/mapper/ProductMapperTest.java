...
public class ProductMapperTest {
    ...
    void shouldMapProductToProductResponseSuccessfully() {
        ...
        assertEquals(product.getProductType().getName(), productResponse.getProductTypeName());
    ...
    void shouldMapProductListToProductResponseListSuccessfully() {
        ...
        var productResponse = list.get(0);
        {
            ...
            assertEquals(ironManCup.getProductType().getName(), productResponse.getProductTypeName());
        ...
        productResponse = list.get(1);
        {
            ...
            assertEquals(batmanCup.getProductType().getName(), productResponse.getProductTypeName());
